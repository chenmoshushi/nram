...
class TestModule(unittest.TestCase):
    ...
    def test_DEC(self):
        self.assertEqual(DEC(self.d0, self.d1).v, 41)
        self.assertEqual(DEC(self.d1, self.d1).v, 6)
    ...
    def test_LT(self):
        self.assertEqual(LT(self.d0, self.d1).v, 0)
        self.assertEqual(LT(self.d1, self.d1).v, 0)
        self.assertEqual(LT(self.d1, self.d0).v, 1)
    ...
    def test_LE(self):
        self.assertEqual(LE(self.d0, self.d1).v, 0)
        self.assertEqual(LE(self.d1, self.d1).v, 1)
        self.assertEqual(LE(self.d1, self.d0).v, 1)
    ...
    def test_MIN(self):
        ...
        self.assertEqual(MIN(self.d0, self.d1).v, self.d1.v)
        self.assertEqual(MIN(self.d1, self.d0).v, self.d1.v)
